...
public class RedBalloonSprite implements DisplayableSprite {

	private static final double VELOCITY = 125;
	...
	public void update(Universe universe, KeyboardInput keyboard, long actual_delta_time) {
		...
		if (((this.centerX > 300) && directionChangeCounter == 0)) {
			direction = Direction.RIGHT;
			directionChangeCounter++;
		}		
		if (((this.centerX > 475) && directionChangeCounter == 1)) {
			direction = Direction.DOWN;
			directionChangeCounter++;
		} 
		if (((this.centerY < 400) && directionChangeCounter == 2)) {
